...
[Draft (PDF)](files/paper1-motive-without-mobilization.pdf) [This version: {{< var paper1.version >}}. The figures on this page come from a later estimation run than the draft, which is being revised to match.]{.disabled}
...
Earthquakes and communal conflict. Draft complete, under revision.
