...
[Draft (PDF)](files/paper1-motive-without-mobilization.pdf) [This version: {{< var paper1.version >}}. <!-- Delete the next sentence once the draft carries the current figures. -->The figures on this page come from a later estimation run than the draft, which is being revised to match.]{.disabled}
